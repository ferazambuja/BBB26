...
<div style="font-weight: 700; margin-bottom: 0.5rem;">Destaques Cartola — Semana {n_weeks}</div>
...
<div class="stat-value">Sem {n_weeks}</div>
...
if display_list:
    ...
    for i, p in enumerate(display_list):
        ...
        if not p['active']:
            ...
            status_badge = f'<span class="fs-xs" style="background: #6c757d; color: #fff; padding: 0.15rem 0.5rem; border-radius: 4px; text-transform: uppercase; margin-left: 0.5rem;">{status_text}</span>'
        elif rank == 1:
        ...
        if p['events']:
            ...
            for evt_type, stats_item in sorted(event_stats.items(), key=lambda x: -abs(x[1]['total'])):
                ...
                event_tags.append(
                    f'<span class="fs-sm" style="background: #383838; padding: 0.2rem 0.5rem; border-radius: 4px; margin: 0.15rem; display: inline-block;">'
...
<div>
<span class="fs-xl" style="font-weight: bold; color: #fff;">{rank_display} {p['name']}</span>
...
''')
        ...
        print(f'''
<div>
<div class="fs-sm" style="color: #f1c40f; text-transform: uppercase;">👑 Líder</div>
<div class="fs-xl" style="font-weight: bold; color: #fff;">{lider}</div>
<div class="fs-base" style="color: #27ae60; font-weight: bold;">+80 pts</div>
</div>
</div>
...
''')
        ...
        print(f'''
<div>
<div class="fs-sm" style="color: #3498db; text-transform: uppercase;">😇 Anjo</div>
<div class="fs-xl" style="font-weight: bold; color: #fff;">{anjo}</div>
<div class="fs-base" style="color: #27ae60; font-weight: bold;">+45 pts</div>
</div>
</div>
...
''')
        ...
        print(f'''
<div>
<div class="fs-sm" style="color: #9b59b6; text-transform: uppercase;">🛡️ Imune</div>
<div class="fs-xl" style="font-weight: bold; color: #fff;">{imune}</div>
<div class="fs-base" style="color: #27ae60; font-weight: bold;">+30 pts</div>
</div>
</div>
...
''')
        ...
        print(f'''
<div>
<div class="fs-sm" style="color: #e74c3c; text-transform: uppercase;">👹 Monstro</div>
<div class="fs-xl" style="font-weight: bold; color: #fff;">{monstro}</div>
<div class="fs-base" style="color: #e74c3c; font-weight: bold;">-10 pts</div>
</div>
</div>
...
''')
        ...
        if week_points_list:
            ...
            print('<div class="info-grid" style="grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 0.8rem;">')
...
<div class="fs-md" style="color: #888;">{events_str}</div>
</div>
...
for event, points in CARTOLA_POINTS.items():
    if points > 0:
        ...
        print(f'<tr><td class="text-light" style="padding: 0.3rem 0;">{emoji} {label}{auto}</td><td class="tr" style="color: #27ae60; font-weight: bold; padding: 0.3rem 0;">+{points}</td></tr>')
...
for event, points in CARTOLA_POINTS.items():
    if points < 0:
        ...
        print(f'<tr><td class="text-light" style="padding: 0.3rem 0;">{emoji} {label}{auto}</td><td class="tr" style="color: #e74c3c; font-weight: bold; padding: 0.3rem 0;">{points}</td></tr>')
