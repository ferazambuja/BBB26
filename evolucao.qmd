...
<table class="diff-table"><thead><tr><th style="background: #222;">↓ / →</th>''']
...
<h4 style="margin:0 0 8px">{leader_av}👑 {leader} <span class="fs-base" style="color:#888;">({start} → {end})</span></h4>
...
if not power_events:
    ...
    print('<thead><tr style="text-align: left; border-bottom: 1px solid #444;">'
          '<th style="padding: 0.5rem;">Data</th><th style="padding: 0.5rem;">Dinâmica</th>'
          '<th style="padding: 0.5rem;">Tipo</th><th style="padding: 0.5rem;">Quem deu</th>'
          '<th style="padding: 0.5rem;">Quem recebeu</th><th style="padding: 0.5rem;">Consequência</th>'
