...
description: "Como o jogo está evoluindo: rankings, sentimento, impacto e pulso diário"
lang: pt-BR
format:
  html:
    code-tools: false
...
<table class="diff-table"><thead><tr><th class="th-soft">↓ / →</th>''']
...
<div style="background: rgba(241,196,15,0.08); border-left: 3px solid #f1c40f; padding: 10px 14px; margin: 8px 0 16px; border-radius: 4px; font-size: var(--fs-md); color: #ccc;">
💰 <strong>Esta seção migrou para a página dedicada</strong> — <a href="economia.html" style="color: #ffe08a;">Economia da Casa</a> tem a análise completa de estalecas, compras, punições, generosidade e VIP & Xepa.
</div>
