...
""")
        ...
        if poll:
            ...
            if _model_pred:
                ...
                print(f'<p class="text-muted" style="font-size:0.8em; margin-top:0.3rem;">ℹ️ Pesos do modelo (por precisão histórica): {" · ".join(_weight_parts)}</p>')
            print()
