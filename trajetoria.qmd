...
if not power_events:
    ...
    for _, row in df_show.iterrows():
        ...
        target_html = f'<div style="display: flex; align-items: center;">{avatar_html}{row["target"]}</div>'
        impact_badge = (
        ...
        print(f'<tr style="border-left: 4px solid {border}; background: {bg};">'
              ...
              f'<td style="padding: 0.45rem 0.5rem;">{row["actor"]}</td>'
