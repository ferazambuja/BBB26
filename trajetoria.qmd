...
if not power_events:
    ...
    def resolve_context(row):
        ...
        if 'prova do líder' in actor:
            return 'Prova do Líder'
        ...
        if 'dinâmica da casa' in actor:
            return 'Dinâmica da casa'
        return '—'

    df_power['Dinâmica'] = df_power.apply(resolve_context, axis=1)
    df_show = df_power.sort_values('Data')[['date', 'Dinâmica', 'Tipo', 'actor', 'target', 'detail', 'impacto']]
    ...
    print('<thead><tr style="text-align: left; border-bottom: 1px solid #444;">'
          ...
          '<th style="padding: 0.5rem;">Dinâmica</th>'
    ...
    for _, row in df_show.iterrows():
        ...
        context_html = render_context_cell(row.get("Dinâmica"))
        impact_badge = (
