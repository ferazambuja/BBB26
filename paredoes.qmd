        ...
        if has_temporal and n_daily >= 3:
            ...
            if recem_inimigos_v:
                ...
                for v in recem_inimigos_v:
                    print(f"- {avatar_html(v['votante'], 22)} → {avatar_html(v['alvo'], 22)}: {v['hist_narrative']}")
                print()
            ...
            if always_friends_voted:
                ...
                for v in always_friends_voted:
                    print(f"- {avatar_html(v['votante'], 22)} → {avatar_html(v['alvo'], 22)}: {v['days_as_friends']} dias de ❤️")
                print()
