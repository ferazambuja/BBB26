...
if len(finalized_polls) >= 1:
    ...
    if rows_5050:
        ...
        print('Em 2026, o BBB passou a usar <strong>70% Voto Único + 30% Voto Torcida</strong>.')
        print('A mudança foi apresentada após críticas de distorção por mutirões de torcida no modelo mais equilibrado.')
        print('Abaixo, simulamos retroativamente como ficariam os paredões finalizados em um cenário <strong>50/50</strong> (metodologia antiga).')
        print('</p>')
