...
if len(finalized_polls) >= 1:
    ...
    if rows_5050:
        ...
        print('Em 2026, o BBB passou a adotar o sistema de <strong>70% Voto Único + 30% Voto da Torcida</strong>, após forte reação negativa do público. A vencedora Roberta, de 2025, apresentou baixíssima popularidade, o que gerou críticas de que os mutirões organizados por torcidas estavam distorcendo o resultado, sobrepondo-se à preferência do público em geral.')
