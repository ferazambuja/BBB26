...
<div class="fs-4xl" style="font-weight: bold; color: #2ecc71;">{mutual_heart_today}</div>
<div class="fs-sm" style="color: rgba(255,255,255,0.7);">❤️ Alianças</div>
</div>
<div style="background: #5a1a1a; border-radius: 8px; padding: 0.8rem 1.2rem; text-align: center;">
<div class="fs-4xl" style="font-weight: bold; color: #e74c3c;">{mutual_neg_today}</div>
<div class="fs-sm" style="color: rgba(255,255,255,0.7);">⚔️ Rivalidades</div>
</div>
<div style="background: #4a2a5a; border-radius: 8px; padding: 0.8rem 1.2rem; text-align: center;">
<div class="fs-4xl" style="font-weight: bold; color: #9b59b6;">{n_breaks}</div>
<div class="fs-sm" style="color: rgba(255,255,255,0.7);">💔 Rupturas</div>
</div>
</div>
""")
```
...
if daily_changes:
    ...
    def _stat_card(emoji, value, label, color):
        return (f'<div style="flex:1; min-width:100px; background:#2a2a2a; border-radius:8px; '
                ...
                f'<div class="fs-sm" style="color:#aaa;">{label}</div></div>')
...
{"".join(cards)}
    ...
    if parts:
        print(f'<div class="fs-base" style="color:#ccc; line-height:1.6;">🔗 {" → ".join(parts)}</div>')
    ...
    if r_mut > 0 or r_blind > 0:
        ...
        print(f'<div class="fs-base" style="color:#91cf60; margin-top:0.5rem;">✅ Resolvidos: {", ".join(res_parts)}</div>')

    if not parts and r_mut == 0 and r_blind == 0:
        print('<div class="fs-base" style="color:#888;">Sem mudanças significativas nas dinâmicas sociais.</div>')
...
if streak_breaks:
    ...
    print('<table class="fs-base" style="width: 100%; border-collapse: collapse;">')
    ...
    for sb in streak_breaks:
        ...
        novo_badge = ('<span class="fs-xs" style="background:#e74c3c; color:white; '
