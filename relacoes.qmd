...
if contradictions:
    ...
    print('<table class="fs-base u-s077">')
    print('<thead><tr class="u-s028">'
          '<th class="u-s004">Votante</th>'
          '<th class="u-s004">Alvo do voto</th>'
          '<th class="u-s004">Queridômetro</th>'
          '<th class="u-s004">Tipo</th>'
          '<th class="u-s004">Semana</th>'
          '<th class="u-s004">Data</th>'
          '</tr></thead><tbody>')
    ...
    for c in contradictions:
        ...
        week = c.get("week", "?")
        date = c.get("date", "?")
        print(f'<tr><td class="u-s004">{voter}</td>'
              f'<td class="u-s004">{target}</td>'
              f'<td class="u-s015">{q_display}</td>'
              f'<td class="u-s015">{vote_kind}</td>'
              f'<td class="u-s015">{week}</td>'
              f'<td class="u-s015">{date}</td></tr>')
    print('</tbody></table></div>')
