...
if not display_scores:
    ...
    for name in sorted(display_scores.keys()):
        ...
        print("<div class='fs-base' style='margin-top:0.5rem;'>")
        ...
        print(f"<div class='fs-base' style='margin-left:1rem; color:#aaa;'>"
        ...
        if power_detail:
            print("<div class='fs-base' style='margin-left:1rem; color:#aaa;'><strong>Pesos por evento:</strong></div>")
            for evd in power_detail:
                other = f" → {evd.get('other')}" if evd.get("other") else ""
                print(f"<div class='fs-md' style='margin-left:1.6rem; color:#999;'>+{evd.get('weight',0)} {evd.get('label')} ({evd.get('role')}){other}</div>")
        ...
        if sinc_part:
            print("<div class='fs-md' style='margin-left:1.6rem; color:#999;'>+1.0 participação</div>")
        for _ in range(raw.get('sincerao_edges', 0)):
            print("<div class='fs-md' style='margin-left:1.6rem; color:#999;'>+0.5 edge</div>")
