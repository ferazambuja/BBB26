...
**Aviso**: Este painel é um projeto independente de análise de dados, sem vínculo com a TV Globo ou o programa BBB. Os dados são coletados da API pública do GloboPlay e complementados com registros manuais — podem conter erros, atrasos ou imprecisões. Utilize como referência, não como fonte oficial. Encontrou um problema? [Abra uma issue no GitHub](https://github.com/ferazambuja/BBB26/issues).
:::
