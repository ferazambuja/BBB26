...
{rows_html}
        ...
        # ── ⚔️ Mais Agressor ──
            ...
            total = card.get("total", len(items))
            worst_aggr = items_all[0].get("power_hits", 1) if items_all else 1
            ...
            for it in inline_items:
                ...
                score = it.get("power_hits", 0)
                bar_pct = min(100, score / worst_aggr * 100) if worst_aggr else 0
                rows_html += (
                    f'<div class="u-s056">'
                    ...
                    f'<span class="fs-sm" style="color:#8e44ad;font-weight:700">{score}</span>'
                    f'</div>'
                    f'<div class="u-s014">'
...
{rows_html}
        ...
        # ── 🛡️ Mais Blindados ──
            ...
            def _blindado_row(it: dict) -> str:
                ...
                prot_badges = []
                if has_bv:
                    prot_badges.append("<span class='fs-2xs' style='padding:1px 6px;border-radius:999px;background:#1b3f5c;color:#9dd3ff;'>BV</span>")
                if prot_text:
                ...
                return (
                    ...
                    f'</div>'
                    f'<div class="fs-2xs" style="color:#888;">{votes} voto{"s" if votes != 1 else ""} em {avail} elegível{"" if avail == 1 else "eis"} · protegido {prot}x</div>'
                    f'{extra_badges}'
                    f'</div></div>'
                )
...
#| output: asis
print(ANALYSIS_DESCRIPTIONS.get("composite_score_chart", ANALYSIS_DESCRIPTIONS.get("composite_score_brief", "")))
```
