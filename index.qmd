        ...
        # ── 💥 Dramatic + ⚠️ Hostilities — pair-based cards ──
            ...
            for it in items[:4]:
                ...
                pairs_html += (
                    ...
                    f'{av(g, 42, g_color)}'
                    f'<span class="fs-md u-s017">{label}</span>'
                    f'{av(r, 42, r_color)}'
                    f'</div>'
                )
            extra = total - 4
        ...
        # ── ⚡ Sincerão ──
            ...
            for it in items[:3]:
                ...
                rows_html += (
                    f'<div class="u-s346">'
                    f'{av(ator, 42, "#e67e22")}'
                    f'<span class="fs-md u-s017">{ator.split()[0]}</span>'
                    f'<span class="fs-xs u-s009">disse <b class="u-s037">{tipo}</b> mas dá</span>'
                    f'<span class="fs-xl">{emoji}</span>'
                    f'<span class="fs-xs u-s009">para</span>'
                    f'{av(alvo, 42, "#27ae60")}'
                    f'<span class="fs-md u-s017">{alvo.split()[0]}</span>'
                    f'</div>'
                )
            rows_html += '</div>'
...
@media (max-width: 575.98px) {
  ...
  #ranking-sentimento .plotly-graph-div,
  #ranking-sentimento .js-plotly-plot,
  #ranking-sentimento .plot-container {
