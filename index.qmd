...
<span>{ctx_active} participantes ativos</span>
    ...
    for card in hl_cards:
        ...
        if ctype == "ranking":
            ...
            podium_html = '<div class="ranking-column">'
            podium_html += '<div class="fs-2xs u-s060 ranking-column__label">⬆ Mais queridos</div>'
            podium_html += '<div class="u-s065 ranking-column__list">'
            for i, p in enumerate(inline_podium):
                ...
                podium_html += (
                    f'<div class="u-s344 ranking-entry ranking-entry--positive">'
                    f'{av(name, 42, border)}'
            ...
            podium_html += '</div></div>'
            if overflow_podium:
                podium_html += '<details class="sinc-more ranking-column__more"><summary>+{} restantes</summary><div class="u-s065 ranking-column__list">'.format(len(overflow_podium))
            ...
            if bottom_all:
                ...
                bottom_html = '<div class="ranking-column">'
                bottom_html += '<div class="fs-2xs u-s060 ranking-column__label">⬇ Menos queridos</div>'
                bottom_html += '<div class="u-s065 ranking-column__list">'
                for p in inline_bottom:
                    name = p["name"]
                    score = p["score"]
                    score_color = "#e74c3c" if score < 0 else ("#f39c12" if score < 3 else "#aaa")
                    bottom_html += (
                        f'<div class="u-s340 ranking-entry ranking-entry--negative">'
                ...
                bottom_html += '</div></div>'
                if overflow_bottom:
                    bottom_html += '<details class="sinc-more ranking-column__more"><summary>+{} restantes</summary><div class="u-s065 ranking-column__list">'.format(len(overflow_bottom))
            ...
            if inline_deltas:
                ...
                movers_html = '<div class="ranking-column">'
                movers_html += f'<div class="fs-2xs u-s060 ranking-column__label">{movers_label}</div>'
                movers_html += '<div class="u-s065 ranking-column__list">'
                for d in inline_deltas:
                    is_up = d.get("delta", 0) >= 0
                    name = d["name"]
                    icon = "📈" if is_up else "📉"
                    row_cls = "u-s345 ranking-entry ranking-entry--delta-up" if is_up else "u-s341 ranking-entry ranking-entry--delta-down"
                ...
                movers_html += '</div></div>'
                if overflow_deltas:
                    movers_html += '<details class="sinc-more ranking-column__more"><summary>+{} restantes</summary><div class="u-s065 ranking-column__list">'.format(len(overflow_deltas))
