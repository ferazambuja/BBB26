...
description: "Comunidades, blocos de votação e dinâmica de grupos no BBB 26"
lang: pt-BR
format:
  html:
    code-tools: false
...
for entry in top3:
    ...
    p_html += f'<div class="u-s364">{avatar_img_html}<div><div class="u-s387">{name}</div><div class="fs-md meta-text">{entry["grupo"]} · {cluster_names[cl]}</div></div></div>'
    p_html += f'<div class="fs-base">'
    p_html += f'<div class="meta-text">Dispersão: <b>{entry["std_received"]:.2f}</b> · Média: <b>{entry["avg_received"]:+.2f}</b></div>'
